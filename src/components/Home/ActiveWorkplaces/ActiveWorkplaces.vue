<script lang="ts" src="./ActiveWorkplaces.ts"></script>
<style lang="scss" src="./ActiveWorkplaces.scss" scoped></style>

<template>
  <div class="active-workplaces-container">
    <div class="title">Aktualne budowy</div>
    <div class="content">
